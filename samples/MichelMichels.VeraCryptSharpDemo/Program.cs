using MichelMichels.CliSharp.Exceptions;
using MichelMichels.VeraCryptSharp;
using System;
using System.IO;

namespace MichelMichels.VeracryptSharpDemo;
...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        else
        {
            ...
            {
                Console.WriteLine("VeraCrypt.exe not found at file path. Aborting.");
                return;
            }
        }
